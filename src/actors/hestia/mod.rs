...
impl Hestia {
    ...
    fn clone_ref(&self) -> Self {
        ...
        Hestia {
            ...
            hades_encryption: RwLock::new(*self.hades_encryption.try_read().unwrap()),
            default_encryption_key: RwLock::new(self.default_encryption_key.try_read().unwrap().clone()),
            last_health_check: RwLock::new(*self.last_health_check.try_read().unwrap()),
            consecutive_errors: RwLock::new(*self.consecutive_errors.try_read().unwrap()),
