...
pub fn t(lang: Language, key: &str) -> String {
    match (lang, key) {
        ...
        // NEWS2 & Innovation
        (Language::En, "news2_title") => "NEWS2 Score".to_string(),
        (Language::Es, "news2_title") => "Puntaje NEWS2".to_string(),
        (Language::En, "news2_subtitle") => "National Early Warning Score 2".to_string(),
        (Language::Es, "news2_subtitle") => "Puntaje Nacional de Alerta Temprana 2".to_string(),
        (Language::En, "calculate_news2") => "Calculate NEWS2 Score".to_string(),
        (Language::Es, "calculate_news2") => "Calcular Puntaje NEWS2".to_string(),
        (Language::En, "news2_risk") => "Clinical Risk".to_string(),
        (Language::Es, "news2_risk") => "Riesgo Clínico".to_string(),
        (Language::En, "news2_low") => "Low".to_string(),
        (Language::Es, "news2_low") => "Bajo".to_string(),
        (Language::En, "news2_medium") => "Medium".to_string(),
        (Language::Es, "news2_medium") => "Medio".to_string(),
        (Language::En, "news2_high") => "High".to_string(),
        (Language::Es, "news2_high") => "Alto".to_string(),
        (Language::En, "radar_chart_title") => "Organ System Status".to_string(),
        (Language::Es, "radar_chart_title") => "Estado por Sistemas".to_string(),
        (Language::En, "organ_respiratory") => "Respiratory".to_string(),
        (Language::Es, "organ_respiratory") => "Respiratorio".to_string(),
        (Language::En, "organ_coagulation") => "Coagulation".to_string(),
        (Language::Es, "organ_coagulation") => "Coagulación".to_string(),
        (Language::En, "organ_liver") => "Liver".to_string(),
        (Language::Es, "organ_liver") => "Hígado".to_string(),
        (Language::En, "organ_cardio") => "Cardio".to_string(),
        (Language::Es, "organ_cardio") => "Cardio".to_string(),
        (Language::En, "organ_cns") => "CNS".to_string(),
        (Language::Es, "organ_cns") => "SNC".to_string(),
        (Language::En, "organ_renal") => "Renal".to_string(),
        (Language::Es, "organ_renal") => "Renal".to_string(),
        ...
        (Language::En, "edit_patient") => "Edit Patient".to_string(),
        (Language::Es, "edit_patient") => "Editar Paciente".to_string(),
        (Language::En, "save_changes") => "Save Changes".to_string(),
        (Language::Es, "save_changes") => "Guardar Cambios".to_string(),
        (Language::En, "confirm_delete_patient") => "Are you sure you want to delete this patient and all their records?".to_string(),
        (Language::Es, "confirm_delete_patient") => "¿Está seguro de eliminar este paciente y todos sus registros?".to_string(),
        (Language::En, "update_clinical_details") => "Update clinical admission details".to_string(),
        (Language::Es, "update_clinical_details") => "Actualice detalles clínicos de admisión".to_string(),
