        ...
        <div class="w-full max-w-7xl mx-auto px-4">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    <div class="space-y-6">
                        <div>
                            <label class="flex justify-between text-sm font-medium text-gray-700 mb-1">
                                <span>{move || t(lang.get(), "temperature")}</span>
                        ...
                        <div>
                            <label class="flex justify-between text-sm font-medium text-gray-700 mb-1">
                                <span>{move || t(lang.get(), "heart_rate")}</span>
                        ...
                        <div>
                            <label class="flex justify-between text-sm font-medium text-gray-700 mb-1">
                                <span>{move || t(lang.get(), "respiratory_rate")}</span>
                ...
                <div class="bg-white rounded-xl shadow-md p-6 border-t-4 border-blue-500">
                    ...
                    <div class="space-y-6">
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">"Oxygenation Type"</label>
                            <select
                        ...
                        <div>
                            <label class="flex justify-between text-sm font-medium text-gray-700 mb-1">
                                <span>{move || t(lang.get(), "arterial_ph")}</span>
                ...
                <div class="bg-white rounded-xl shadow-md p-6 border-t-4 border-purple-500">
                    ...
                    <div class="space-y-6">
                        <div>
                            <label class="flex justify-between text-sm font-medium text-gray-700 mb-1">
                                <span>{move || t(lang.get(), "sodium")}</span>
                        ...
                        <div>
                            <label class="flex justify-between text-sm font-medium text-gray-700 mb-1">
                                <span>{move || t(lang.get(), "potassium")}</span>
                        ...
                        <div>
                            <label class="flex justify-between text-sm font-medium text-gray-700 mb-1">
                                <span>{move || t(lang.get(), "creatinine")}</span>
                        ...
                        <div>
                            <label class="flex justify-between text-sm font-medium text-gray-700 mb-1">
                                <span>{move || t(lang.get(), "hematocrit")}</span>
                ...
                <div class="bg-white rounded-xl shadow-md p-6 border-t-4 border-indigo-500">
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">{move || t(lang.get(), "chronic_health")}</label>
                            <select
